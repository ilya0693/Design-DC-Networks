...
В данном разделе описаны правила именование площадок, устройств и конфигурационных элементов. Также описано, как назначать ASN, Lo интерфейсы, MTU, ae интерфейсы, VNI и т.д. Данный раздел создан с целью упростить понимание архитектуры и процессы эксплуатации оборудования, а также облегчить процесс поиска неполадок. 

### _6.1. Правила обозначения площадок_
Для того, чтобы упростить понимание, на какой площадке находится ЦОД ему назначают уникальный идентификатор **_dxx_**, где **_d_** расшифровывается как Data Center (в переводе на русский Центр Обработки Данных), а xxx - значение от 1 до 999. В нашем случае каждой площадке присваиваются следующие номера:
