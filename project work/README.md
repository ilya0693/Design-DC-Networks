...
### _6. Общие сведения по сети ЦОД_
...
{site_name} - идентификатор площадки, на которой установлено устройство, длина – 3 символа, используемые символы: a-z, 0-9, нижний регистр. В рамках данного проекта используются площадки с кодами d77 и d26.
